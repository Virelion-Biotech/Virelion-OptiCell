"""Experiment-level statistics with replicate-aware aggregation.

The functions in this module deliberately operate at the experiment/replicate
level rather than pretending every segmented cell is an independent biological
replicate.
"""
...
def group_summary(
    ...
    """Compare experimental groups using replicate-level summaries."""
